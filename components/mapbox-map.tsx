...
function getRegions() {
  ...
  return {
    nouns: { center: (isMobile ? [-81, 16] : [-79, 14]) as [number, number], zoom: isMobile ? 2.7 : 4.0, label: "🌎 NOUNS", subtitle: "North & Central America" },
    verbs: { center: (isMobile ? [-65, -14] : [-68, -6]) as [number, number], zoom: isMobile ? 2.3 : 2.8, label: "🌍 VERBS", subtitle: "South America" },
  }
}
